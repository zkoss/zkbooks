...
public class CDIUtil {
	...
	public static BeanManager getBeanManager() {
		...
		try {
			String jndiName = Library.getProperty("org.zkoss.zkplus.cdi.beanManager.jndiName");
			if (jndiName == null) {
				_manager = javax.enterprise.inject.spi.CDI.current().getBeanManager();
			}else {
				final InitialContext initialContext = new InitialContext();
				_manager = (BeanManager) initialContext.lookup(jndiName);
			}
